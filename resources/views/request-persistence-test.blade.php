...
@section('content')
    <div class="container">
        <h1>{{ $test_type ?? 'Request Persistence Test' }}</h1>
        ...
        <div class="test-overview">
            <h3>🔍 Test Overview</h3>
            <p>This test verifies whether service instances persist between different HTTP requests. It tracks instance IDs and object hashes across multiple requests to determine if Laravel's service container reuses instances or creates new ones.</p>
        ...
        @if(isset($analysis['status']) && $analysis['status'] === 'insufficient_data')
            <div class="conclusion">
                ...
                <p>Please refresh the page to make more requests and analyze persistence behavior.</p>
            </div>
        @else
            <div class="conclusion">
        ...
        <div class="request-card current-request">
            ...
            <div class="service-data">
                <div class="service-card">
                    <div class="service-title">TestService</div>
                    <div class="property">
                        <span class="property-label">Instance ID:</span>
                        <span class="property-value">{{ $current_request['test_service']['instance_id'] }}</span>
                    </div>
                    <div class="property">
                        <span class="property-label">Object Hash:</span>
                        <span class="property-value">{{ $current_request['test_service']['object_hash'] }}</span>
                    </div>
                                         <div class="property">
                         <span class="property-label">Message:</span>
                         <span class="property-value">{{ $current_request['test_service']['data']['message'] ?? 'None' }}</span>
                     </div>
                </div>
                
                <div class="service-card">
                    <div class="service-title">BaseService</div>
                    <div class="property">
                        <span class="property-label">Instance ID:</span>
                        <span class="property-value">{{ $current_request['base_service']['instance_id'] }}</span>
                    </div>
                    <div class="property">
                        <span class="property-label">Object Hash:</span>
                        <span class="property-value">{{ $current_request['base_service']['object_hash'] }}</span>
                    </div>
                    <div class="property">
                        <span class="property-label">Action Count:</span>
                        <span class="property-value">{{ $current_request['base_service']['action_count'] }}</span>
                    </div>
                </div>
                
                <div class="service-card">
                    <div class="service-title">DependentService</div>
                    <div class="property">
                        <span class="property-label">Instance ID:</span>
                        <span class="property-value">{{ $current_request['dependent_service']['instance_id'] }}</span>
                    </div>
                    <div class="property">
                        <span class="property-label">Object Hash:</span>
                        <span class="property-value">{{ $current_request['dependent_service']['object_hash'] }}</span>
                    </div>
                    <div class="property">
                        <span class="property-label">Test Service ID:</span>
                        <span class="property-value">{{ $current_request['dependent_service']['data']['test_service']['id'] ?? 'N/A' }}</span>
                    </div>
                </div>
            </div>
        </div>
        
        @if(isset($analysis['test_service_analysis']))
            <h2>📊 Persistence Analysis</h2>
            <div class="analysis-grid">
                @foreach(['test_service_analysis', 'base_service_analysis', 'dependent_service_analysis'] as $key)
                    @if(isset($analysis[$key]))
                        ...
                        <div class="analysis-card">
                            <h3>{{ ucfirst(str_replace('_', ' ', $serviceAnalysis['service_name'])) }}</h3>
            ...
            <div class="request-card">
                ...
                <div class="service-data">
                    <div class="service-card">
                        ...
                        <div class="property">
                            <span class="property-label">Instance ID:</span>
                            <span class="property-value">{{ $request['test_service']['instance_id'] }}</span>
                        </div>
                        <div class="property">
                            <span class="property-label">Object Hash:</span>
                            <span class="property-value">{{ $request['test_service']['object_hash'] }}</span>
                        </div>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <div class="property">
                            <span class="property-label">Instance ID:</span>
                            <span class="property-value">{{ $request['base_service']['instance_id'] }}</span>
                        </div>
                        <div class="property">
                            <span class="property-label">Object Hash:</span>
                            <span class="property-value">{{ $request['base_service']['object_hash'] }}</span>
                        </div>
                        <div class="property">
                            <span class="property-label">Action Count:</span>
                            <span class="property-value">{{ $request['base_service']['action_count'] }}</span>
                        </div>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <div class="property">
                            <span class="property-label">Instance ID:</span>
                            <span class="property-value">{{ $request['dependent_service']['instance_id'] }}</span>
                        </div>
                        <div class="property">
                            <span class="property-label">Object Hash:</span>
                            <span class="property-value">{{ $request['dependent_service']['object_hash'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
